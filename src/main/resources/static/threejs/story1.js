...
import { FontLoader } from 'examples/FontLoader.js.js';
import { TextGeometry } from 'examples/TextGeometry.js';
import { GLTFLoader } from 'examples/GLTFLoader.js.js';
import { FBXLoader } from "examples/FBXLoader.js.js";
...
class App {
  constructor() {
    ...
    const renderer = new THREE.WebGLRenderer({ divContainer, 
      alpha: true,
      antialias: true});
    ...
    _setupTitle(){
      ...
      loader.load("data/Do_Regular.json",
        (font) => {
          const geometry = new TextGeometry("토끼와_거북이\n#1", 
    ...
    _setupFloor(){
      ...
      const ground_meterial = new THREE.MeshBasicMaterial({
        map: loader.load('images/grass1.jpg'),
      });
    ...
    _setupRabbit() {
      ...
      loader.load('data/Jumping.fbx', rabbit => {
